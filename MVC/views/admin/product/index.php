<div class="content-wrapper"> 
	...
	<div class="card">
              <div class="card-header">
                <h3 class="card-title">DataTable OF Product</h3>
              </div>
              <!-- /.card-header -->
             <div class="card-body">
                <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4"><div class="row"><div class="col-sm-12 col-md-6"></div><div class="col-sm-12 col-md-6"></div></div><div class="row"><div class="col-sm-12"><table id="example2" class="table table-bordered table-hover dataTable dtr-inline" role="grid" aria-describedby="example2_info">
                  ...
                  <tr role="row" class="even">
                    <td class="sorting_1" tabindex="0"> <?php echo $value['tensp']; ?></td>
                    <td><img src="<?php echo URL_LAYOUT.'img/product/'.$value['img']; ?>" width="50px" alt=""></td>
                    <td><?php echo $value['gia']; ?></td>
                    <td><?php echo $value['soluong']; ?></td>
                    <td><?php echo $value['xuatxu']; ?></td>

                    <td style=""><a href=" <?php echo URL."product/edit/${value['id']}" ?>">Edit</a></td>
                    <td style=""><a href=" <?php echo URL."product/delete/${value['id']}" ?>">Delete</a></td>
                  </tr>
              <?php } ?>
              </tbody>
